...
- **Workflow commands:** `/af-create-backbone`, `/af-create-slice`, `/af-review-slice`, `/af-create-story`, `/af-create-spec`, `/af-create-bug`, `/af-implement-spec`, `/af-fix-bug`. Each maps to one phase of the workflow.
