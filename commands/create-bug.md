...
**Key difference from /create-spec:** Lead is allowed to read source files to identify root cause — but only files directly related to the bug, not broad exploration.
